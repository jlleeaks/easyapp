...
export function BookSuggestionsCard({ childId, onAdded }: { childId: string; onAdded: (book: Book) => void }) {
    ...
    <Card style={{ marginBottom: 0 }}>
      <div className="p-5">
        <div className="flex items-center gap-1.5 mb-1">
          ...
          <Eyebrow color={PALETTE.gold}>Worth adding to the shelf</Eyebrow>
        </div>
        ...
        {loading ? (
          <div className="animate-pulse flex flex-col gap-2.5">
            <div className="h-16 rounded-xl" style={{ background: PALETTE.line }} />
            <div className="h-16 rounded-xl" style={{ background: PALETTE.line }} />
          </div>
        ) : (
          <div className="flex flex-col gap-2.5">
            {suggestions.map((s) => {
              ...
              return (
                <div key={s.title} className="rounded-xl p-3" style={{ background: PALETTE.bg, border: `1px solid ${PALETTE.line}` }}>
                  <div className="flex items-start gap-2.5">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs mb-1" style={{ color: PALETTE.inkSoft }}>
                        {s.author} · {s.theme}
                      </p>
                  ...
                  <button
                    ...
                    className="btn-press mt-2.5 w-full flex items-center justify-center gap-1.5 text-xs font-bold py-2 rounded-lg transition-all duration-150"
                    style={{

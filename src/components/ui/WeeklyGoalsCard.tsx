...
export function WeeklyGoalsCard({
      ...
      <div className="rounded-3xl p-6" style={{ background: PALETTE.card, border: `1px solid ${PALETTE.line}` }}>
        ...
        <div className="max-w-sm">
          ...
          <button
            ...
            disabled={suggesting}
            className="btn-press flex items-center justify-center gap-1.5 text-xs font-bold py-2 mb-2 transition-all duration-150 w-full"
    ...
    return (
      <div className="rounded-3xl p-6" style={{ background: PALETTE.card, border: `1px solid ${PALETTE.line}` }}>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          <Target size={20} color={PALETTE.inkFaint} className="flex-shrink-0" />
          ...
          <button
            ...
            className="btn-press text-sm font-bold py-2.5 px-4 flex-shrink-0 transition-all duration-150"
  ...
  return (
    <div className="rounded-3xl p-6" style={{ background: PALETTE.card, border: `1px solid ${PALETTE.line}` }}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-x-6 gap-y-4" style={{ marginTop: isSuggested ? 0 : 12 }}>
